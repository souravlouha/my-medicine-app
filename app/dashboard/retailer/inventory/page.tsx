...
// ✅ FIX: এই লাইনটি যোগ করুন। এটি পেজ ক্যাশিং বন্ধ করবে এবং সবসময় লেটেস্ট ডাটা দেখাবে।
                  ...
                  <div className="mt-6 pt-4 border-t flex justify-between items-center">
                     ...
                     <div className="text-right">
                        <div className={`text-xl font-bold ${item.currentStock < 10 ? 'text-red-600' : 'text-emerald-600'}`}>
                           {item.currentStock} <span className="text-sm font-normal text-slate-500">Strips</span>
                        </div>
                        {/* লুজ ট্যাবলেট থাকলে দেখাবে */}
                        {item.looseStock > 0 && (
                            <div className="text-xs font-bold text-amber-600">
                                + {item.looseStock} Loose Tabs
                            </div>
                        )}
                     </div>
                  </div>
